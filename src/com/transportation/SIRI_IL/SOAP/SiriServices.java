...
@WebServiceClient(name = "SiriServices", 
                  wsdlLocation = "classpath:../wsdl/siri_wsProducer-Israel.wsdl",
...
public class SiriServices extends Service {
    ...
    static {
    	Class<SiriServices> tmp1 = SiriServices.class;
    	ClassLoader tmp2 = tmp1.getClassLoader();
    	
        URL url = SiriServices.class.getClassLoader().getResource("../wsdl/siri_wsProducer-Israel.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(SiriServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "wsdl/siri_wsProducer-Israel.wsdl");
        }       
        WSDL_LOCATION = url;
    }
